...
class ProductPricing(models.Model):
    _name = 'product.equipment.pricing'
    ...
    recurrence_id = fields.Many2one(
        comodel_name='sale.temporal.recurrence.equipment', string="Renting Period", required=True)
    ...
    def _check_unique_parameters(self):
        ...
        for price in self.product_template_id.equipment_product_pricing_ids:
            key_list = [
    ...
    def _get_pricing_samples(self):
        ...
        result = self.env['product.equipment.pricing']
    ...
    def _get_suitable_pricings(self, product, pricelist=None, first=False):
        ...
        available_pricings = self.env['product.equipment.pricing']
        if pricelist:
            for pricing in product.equipment_product_pricing_ids:
