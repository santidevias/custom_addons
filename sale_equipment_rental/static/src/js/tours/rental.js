...
registry.category("web_tour.tours").add('rental_tour', {
    ...
    trigger: '.dropdown-item[data-menu-xmlid="sale_renting.menu_equipment_rental_products"]',
    ...
    trigger: 'button[data-menu-xmlid="sale_renting.equipment_rental_order_menu"]',
    extra_trigger: '.o_form_button_create', // wait for the new product to be saved
    content: _t("Let's now create an order."),
    position: 'bottom',
}, {
    trigger: '.dropdown-item[data-menu-xmlid="sale_renting.equipment_rental_orders_all"]',
